...
data class BookingFormState(
    ...
    val pushPromptReminderHours: List<Int>? = null,
...
class BookingFormStore(
    ...
    private val pushPermissionPromptCoordinator: PushPermissionPromptCoordinator,
    ...
    override fun accept(intent: BookingFormIntent) {
        when (intent) {
            ...
            BookingFormIntent.SuccessDismissed -> mutableState.update {
                it.copy(
                    createdBooking = null,
                    pushPromptReminderHours = null,
                )
            }
    ...
    private fun submit() {
        ...
        storeScope.launch {
            ...
            val createResult = bookingRepository.createBooking(
                draft = BookingDraft(
                    slot = slot,
            ...
            val booking = createResult.getOrNull()
            if (booking != null) {
                val pushPromptReminderHours = pushPermissionPromptCoordinator.requestIfNeeded(booking)
                mutableState.update {
                    it.copy(
            ...
            handleFailure(failure?.asAppFailure() ?: AppFailure.Unknown)
        }
    }
