...
import com.volna.app.notifications.DefaultPushPermissionPromptCoordinator
import com.volna.app.notifications.PlatformPushPermissionPromptStateStorage
import com.volna.app.notifications.PlatformPushPermissionRequester
import com.volna.app.notifications.PushPermissionPromptCoordinator
import com.volna.app.notifications.PushPermissionPromptStateStorage
import com.volna.app.notifications.PushPermissionRequester
...
val volnaAppModule = module {
    ...
    single<PushPermissionPromptStateStorage> { PlatformPushPermissionPromptStateStorage }
    single<PushPermissionRequester> { PlatformPushPermissionRequester }
    single<PushPermissionPromptCoordinator> { DefaultPushPermissionPromptCoordinator(get(), get()) }
