...
class PhoneInputCoreTest {
    ...
    @Test
    fun `sanitize converts trunk 8-prefixed russian phone to local digits`() {
        assertEquals("9991234567", sanitizePhoneInput("89991234567"))
    }
    ...
    @Test
    fun `normalize converts 8-prefixed russian phone to e164`() {
        assertEquals("+79991234567", normalizePhoneE164("89991234567"))
    }
